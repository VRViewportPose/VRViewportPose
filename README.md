...
We convert the recorded Euler angles to polar angle *θ* and azimuth angle *φ*. After applying rotation matrix **R**, we have
...
From the above equation, *θ* is calculated as *θ*=sin*α*sin*γ*-cos*α*sin*β*cos*γ*, and *φ* is given by 
...
where *φ'*=atan((cos*γ*sin*α*sin*β*+cos*α*sin*γ*)/(cos*β*cos*γ*)).<span style="font-family:Papyrus; font-size:4em;">
